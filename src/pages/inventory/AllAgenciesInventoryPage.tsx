...
const AllAgenciesInventoryPage: React.FC = () => {
  ...
  const handleBorrowRequest = async () => {
    ...
    try {
      ...
      // Create borrow request with correct data structure
      await borrowAPI.createBorrowRequest({
        ...
        purpose: 'Temporary use' // This should be made configurable
      });

      setShowQuantityDialog(false);
      // Navigate to the borrow request page
      navigate('/borrow');
    } catch (err: any) {
          ...
          {showQuantityDialog && selectedItem && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-6 max-w-md w-full">
                <h3 className="text-lg font-medium text-gray-900 mb-4">Enter Quantity to Borrow</h3>
                <div className="mb-4">
