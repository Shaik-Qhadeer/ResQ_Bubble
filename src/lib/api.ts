...
export const authAPI = {
  ...
  loginWithId: async (credentials: Credentials) => {
    const response = await api.post('/auth/login-with-id', credentials);
    return response.data;
  },
...
export const borrowAPI = {
  getAllBorrowRequests: async (params: UserParams) => {
...
export const alertAPI = {
  getAgencyAlerts: async (agencyId: string) => {
    const response = await api.get(`/alerts/agency/${agencyId}`);
    return response.data;
  },
  getSentAlerts: async (agencyId: string) => {
    const response = await api.get(`/alerts/sent/${agencyId}`);
    return response.data;
  },
  getUnreadCount: async (agencyId: string) => {
    const response = await api.get(`/alerts/unread/count/${agencyId}`);
    return response.data;
  },
  createAlert: async (alertData: AlertData) => {
  ...
  deactivateAlert: async (alertId: string) => {
    const response = await api.put(`/alerts/${alertId}/deactivate`);
    return response.data;
  }
};
// Transfer API
export const transferAPI = {
  ...
  updateLocation: async (id: string, locationData: any) => {
    const response = await api.put(`/transfers/${id}/location`, locationData);
    return response.data;
  },
  ...
  addPhoto: async (id: string, photoData: any) => {
    const response = await api.post(`/transfers/${id}/photos`, photoData);
    return response.data;
  },
  getTransferHistory: async (agencyId: string, params?: any) => {
    const response = await api.get(`/transfers/history/${agencyId}`, { params });
    return response.data;
  },
  sendEmergencyAlert: async (id: string, alertData: any) => {
    const response = await api.post(`/transfers/${id}/emergency`, alertData);
    return response.data;
  }
};
